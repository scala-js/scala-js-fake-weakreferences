inThisBuild(Def.settings(
  ...
  // Licensing
  homepage := Some(url("https://github.com/scala-js/scala-js-fake-weakreferences")),
  startYear := Some(2013),
  licenses += (("Apache-2.0", url("https://www.apache.org/licenses/LICENSE-2.0"))),
  scmInfo := Some(ScmInfo(
      url("https://github.com/scala-js/scala-js-fake-weakreferences"),
      "scm:git:git@github.com:scala-js/scala-js-fake-weakreferences.git",
      Some("scm:git:git@github.com:scala-js/scala-js-fake-weakreferences.git"))),
...
val commonSettings = Def.settings(
  ...
  headerLicense := Some(HeaderLicense.Custom(
    s"""scalajs-fake-weakreferences (${homepage.value.get})
       |
       |Copyright EPFL.
       |
...
lazy val root: Project = project.in(file("."))
  ...
  .settings(
    name := "scalajs-fake-weakreferences",
